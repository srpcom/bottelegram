...
TRIPAY_PRIVATE_KEY="GqoGJ-86JmH-knzMg-Zmu6n-XZaYRy"
...
# 7. Membuat Skrip Inisialisasi Database (setup_db.py)
...
def main():
    ...
    sql_create_vouchers_table = """
    CREATE TABLE IF NOT EXISTS vouchers (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        kode TEXT NOT NULL UNIQUE,
        tipe_potongan TEXT NOT NULL,
        nilai_potongan INTEGER NOT NULL,
        tanggal_kadaluwarsa TEXT NOT NULL,
        batas_penggunaan INTEGER NOT NULL,
    ...
    if conn is not None:
        ...
        create_table(conn, sql_create_vouchers_table)
        conn.close()
...
log_warn "1. Salin konten untuk 'bot.py' dari Gemini."
